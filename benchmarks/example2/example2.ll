; ModuleID = 'benchmarks/example2/example2.cpp'
source_filename = "benchmarks/example2/example2.cpp"
...
define dso_local noundef double @_Z1fdd(double noundef %x, double noundef %y) local_unnamed_addr #0 {
entry:
  %sub = fsub double %x, %y
  ret double %sub
}
...
entry:
  %sub.i = fadd double 2.000000e+00, -3.000000e+00
  %call.i = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo9_M_insertIdEERSoT_(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, double noundef %sub.i)
...
!4 = !{!"clang version 18.0.0 (https://github.com/llvm/llvm-project.git ff96567bd0fb8ed7a4739afa27a3cf3908115021)"}
!5 = !{!6, !6, i64 0}

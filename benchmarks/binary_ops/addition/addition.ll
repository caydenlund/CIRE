; ModuleID = 'addition.cpp'
source_filename = "addition.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_addition.cpp, i8* null }]
...
define dso_local double @_Z1fdd(double %x, double %y) local_unnamed_addr #4 {
  %1 = fadd double %x, %y
  ret double %1
}
...
define dso_local i32 @main() local_unnamed_addr #5 {
  %1 = call double @_Z1fdd(double 2.000000e+00, double 3.000000e+00)
...
; Function Attrs: uwtable
define internal void @_GLOBAL__sub_I_addition.cpp() #0 section ".text.startup" {

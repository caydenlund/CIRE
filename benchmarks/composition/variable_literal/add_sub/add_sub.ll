...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_add_sub.cpp, i8* null }]
...
define dso_local float @src(float %x, float %y) local_unnamed_addr #4 {
  %1 = fadd float %x, 0xC00F333340000000
  %2 = fadd float %1, %y
  ret float %2
}
...
define dso_local i32 @main() local_unnamed_addr #5 {
  %1 = call float @src(float 2.000000e+00, float 3.000000e+00)
  %2 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull dereferenceable(8) @_ZSt4cout, float %1)
...
define available_externally dso_local nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull dereferenceable(8) %0, float %1) local_unnamed_addr #6 align 2 {
  %3 = fpext float %1 to double
  %4 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo9_M_insertIdEERSoT_(%"class.std::basic_ostream"* nonnull dereferenceable(8) %0, double %3)
...
; Function Attrs: uwtable
define internal void @_GLOBAL__sub_I_add_sub.cpp() #0 section ".text.startup" {

; ModuleID = '/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/NMSE3.3.5.c'
source_filename = "/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/NMSE3.3.5.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: mustprogress nofree nounwind willreturn memory(write) uwtable
define dso_local double @ex0(double noundef %x, double noundef %eps) local_unnamed_addr #0 {
entry:
  %add = fadd double %x, %eps
  %call = tail call double @cos(double noundef %add) #2, !tbaa !5
  %call1 = tail call double @cos(double noundef %x) #2, !tbaa !5

; ModuleID = 'benchmarks_c/matrixDeterminant2.c'
source_filename = "benchmarks_c/matrixDeterminant2.c"
...
entry:
  ...
  %1 = insertelement <2 x double> %0, double %e, i64 1
  %2 = insertelement <2 x double> poison, double %g, i64 0
  %3 = insertelement <2 x double> %2, double %i, i64 1
  ...
  %10 = insertelement <2 x double> poison, double %h, i64 0
  %11 = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> zeroinitializer
  %12 = fmul <2 x double> %8, %11
  %13 = insertelement <2 x double> %1, double %a, i64 1
  %14 = fmul <2 x double> %12, %13
  %15 = shufflevector <2 x double> %14, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %16 = shufflevector <2 x double> %3, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %17 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %16, <2 x double> %9, <2 x double> %15)
  %18 = insertelement <2 x double> %13, double %e, i64 0
  %19 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %18, <2 x double> %4, <2 x double> %17)

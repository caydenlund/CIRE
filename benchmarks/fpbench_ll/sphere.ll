; ModuleID = 'benchmarks_c/sphere.c'
source_filename = "benchmarks_c/sphere.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: mustprogress nofree nounwind willreturn memory(write) uwtable
define dso_local double @ex0(double noundef %x, double noundef %r, double noundef %lat, double noundef %lon) local_unnamed_addr #0 {
entry:
  %call = tail call double @sin(double noundef %lat) #3, !tbaa !5
  %call1 = tail call double @cos(double noundef %lon) #3, !tbaa !5
  %mul = fmul double %call, %r
  %0 = tail call double @llvm.fmuladd.f64(double %mul, double %call1, double %x)
  ret double %0
}

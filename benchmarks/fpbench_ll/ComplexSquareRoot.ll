; ModuleID = 'benchmarks_c/ComplexSquareRoot.c'
source_filename = "benchmarks_c/ComplexSquareRoot.c"
...
entry:
  ...
  %add = fadd double %sqrt, %re
  %mul = fmul double %add, 2.000000e+00
  %call2 = tail call double @sqrt(double noundef %mul) #4, !tbaa !5

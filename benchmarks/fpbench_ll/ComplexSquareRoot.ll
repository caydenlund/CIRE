; ModuleID = '/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/ComplexSquareRoot.c'
source_filename = "/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/ComplexSquareRoot.c"
...
entry:
  %mul1 = fmul double %im, %im
  %0 = tail call double @llvm.fmuladd.f64(double %re, double %re, double %mul1)
  %call = tail call double @sqrt(double noundef %0) #3, !tbaa !5
  %add = fadd double %call, %re
  %mul = fmul double %add, 2.000000e+00
  %call2 = tail call double @sqrt(double noundef %mul) #3, !tbaa !5
  %mul3 = fmul double %call2, 5.000000e-01
  ret double %mul3
}

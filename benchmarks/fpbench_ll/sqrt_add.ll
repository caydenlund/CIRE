; ModuleID = '/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/sqrt_add.c'
source_filename = "/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/sqrt_add.c"
...
entry:
  ...
  %call = tail call double @sqrt(double noundef %add) #2, !tbaa !5
  %call1 = tail call double @sqrt(double noundef %x) #2, !tbaa !5
  %add2 = fadd double %call, %call1
  %div = fdiv double 1.000000e+00, %add2
  ret double %div
}

; ModuleID = '/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/NMSE3.4.4.c'
source_filename = "/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/NMSE3.4.4.c"
...
entry:
  ...
  %sub2 = fadd double %call1, -1.000000e+00
  %div = fdiv double %sub, %sub2
  %call3 = tail call double @sqrt(double noundef %div) #2, !tbaa !5
  ret double %call3
}

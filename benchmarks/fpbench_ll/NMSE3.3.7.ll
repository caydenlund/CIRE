; ModuleID = '/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/NMSE3.3.7.c'
source_filename = "/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/NMSE3.3.7.c"
...
entry:
  ...
  %sub = fadd double %call, -2.000000e+00
  %fneg = fneg double %x
  %call1 = tail call double @exp(double noundef %fneg) #2, !tbaa !5
  %add = fadd double %sub, %call1
  ret double %add
}

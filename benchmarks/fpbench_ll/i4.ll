; ModuleID = '/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/i4.c'
source_filename = "/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/i4.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: mustprogress nofree nounwind willreturn memory(write) uwtable
define dso_local float @ex0(float noundef %x, float noundef %y) local_unnamed_addr #0 {
entry:
  %0 = tail call float @llvm.fmuladd.f32(float %y, float %y, float %x)
  %call = tail call float @sqrtf(float noundef %0) #3, !tbaa !5
  ret float %call
}

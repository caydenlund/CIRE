; ModuleID = 'benchmarks_c/NMSE3.3.1.c'
source_filename = "benchmarks_c/NMSE3.3.1.c"
...
entry:
  ...
  %0 = insertelement <2 x double> poison, double %add, i64 0
  %1 = insertelement <2 x double> %0, double %x, i64 1

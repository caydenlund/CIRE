; ModuleID = 'benchmarks_c/NMSE3.3.4.c'
source_filename = "benchmarks_c/NMSE3.3.4.c"
...
entry:
  ...
  %call = tail call double @pow(double noundef %add, double noundef 0x3FD5555555555555) #2, !tbaa !5
  %call1 = tail call double @pow(double noundef %x, double noundef 0x3FD5555555555555) #2, !tbaa !5

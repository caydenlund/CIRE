; ModuleID = 'benchmarks_c/NMSE3.4.6.c'
source_filename = "benchmarks_c/NMSE3.4.6.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: mustprogress nofree nounwind willreturn memory(write) uwtable
define dso_local double @ex0(double noundef %x, double noundef %n) local_unnamed_addr #0 {
entry:
  %add = fadd double %x, 1.000000e+00
  %div = fdiv double 1.000000e+00, %n
  %call = tail call double @pow(double noundef %add, double noundef %div) #2, !tbaa !5
  %call2 = tail call double @pow(double noundef %x, double noundef %div) #2, !tbaa !5

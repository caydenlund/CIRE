...
void Cire::setDebugLevel(unsigned int level) { debugLevel = level; }

void Cire::setLogLevel(unsigned int level) { logLevel = level; }
...
void Cire::setCollectErrorComponentData(bool _value) { graph->collect_error_component_data = _value; }

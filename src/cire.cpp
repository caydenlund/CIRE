...
namespace {
    cl::opt<string> Func("function", cl::desc("Function to analyze"),
                         cl::value_desc("Used for matching the function name"), cl::init(""), cl::Required);
...
llvm::PassPluginLibraryInfo getCIREPluginInfo() {
    return {LLVM_PLUGIN_API_VERSION, "CIRE", LLVM_VERSION_STRING, [](PassBuilder& PB) {
...
extern "C" LLVM_ATTRIBUTE_WEAK ::llvm::PassPluginLibraryInfo llvmGetPassPluginInfo() { return getCIREPluginInfo(); }
...
int main(int argc, char** argv) {
    ...
    llvm::FunctionType* nextafterFuncType = llvm::FunctionType::get(
            builder.getFloatTy(), {builder.getFloatTy(), builder.getFloatTy()}, false);
    llvm::Function* nextafterf = llvm::Function::Create(nextafterFuncType, llvm::Function::ExternalLinkage,
    ...
    llvm::ValueToValueMapTy VMap;
    llvm::Function* shadowFunction = llvm::Function::Create(shadowFunctionType, llvm::Function::ExternalLinkage,
    ...
    auto* globalVar = new llvm::GlobalVariable(*newModule, formatStr->getType(),
                                               true,  // Constant
                                               llvm::GlobalValue::PrivateLinkage, formatStr, ".str");
    llvm::Value* fmtStr = llvm::ConstantExpr::getPointerCast(
            globalVar, llvm::PointerType::getUnqual(llvm::IntegerType::get(context, 8)));

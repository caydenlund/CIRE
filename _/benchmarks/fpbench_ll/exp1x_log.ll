; ModuleID = '/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/exp1x_log.c'
source_filename = "/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/exp1x_log.c"
...
entry:
  %call = tail call double @exp(double noundef %x) #2, !tbaa !5
  %sub = fadd double %call, -1.000000e+00
  %call1 = tail call double @exp(double noundef %x) #2, !tbaa !5
  %call2 = tail call double @log(double noundef %call1) #2, !tbaa !5

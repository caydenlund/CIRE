; ModuleID = '/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/polarToCarthesian_y.c'
source_filename = "/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/polarToCarthesian_y.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: mustprogress nofree nounwind willreturn memory(write) uwtable
define dso_local double @ex0(double noundef %radius, double noundef %theta) local_unnamed_addr #0 {
entry:
  %mul = fmul double %theta, 0x3F91DF46A2529E84
  %call = tail call double @sin(double noundef %mul) #2, !tbaa !5
  %mul1 = fmul double %call, %radius
  ret double %mul1
}

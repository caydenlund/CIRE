; ModuleID = '/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/hypot.c'
source_filename = "/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/hypot.c"
...
entry:
  %mul1 = fmul double %x2, %x2
  %0 = tail call double @llvm.fmuladd.f64(double %x1, double %x1, double %mul1)

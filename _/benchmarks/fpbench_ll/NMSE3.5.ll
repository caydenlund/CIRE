; ModuleID = '/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/NMSE3.5.c'
source_filename = "/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/NMSE3.5.c"
...
entry:
  ...
  %call = tail call double @atan(double noundef %add) #2, !tbaa !5
  %call1 = tail call double @atan(double noundef %N) #2, !tbaa !5

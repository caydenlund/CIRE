; ModuleID = '/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/carthesianToPolar_theta.c'
source_filename = "/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/carthesianToPolar_theta.c"
...
entry:
  %div = fdiv double %y, %x
  %call = tail call double @atan(double noundef %div) #2, !tbaa !5
  %mul = fmul double %call, 0x404CA5DC1A63BFE5
  ret double %mul
}

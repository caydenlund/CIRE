; ModuleID = '/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/NMSE3.2.1_negative.c'
source_filename = "/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/NMSE3.2.1_negative.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: mustprogress nofree nounwind willreturn memory(write) uwtable
define dso_local double @ex0(double noundef %a, double noundef %b2, double noundef %c) local_unnamed_addr #0 {
entry:
  %fneg = fneg double %b2
  %0 = fneg double %a
  %neg = fmul double %0, %c
  %1 = tail call double @llvm.fmuladd.f64(double %b2, double %b2, double %neg)
  %call = tail call double @sqrt(double noundef %1) #3, !tbaa !5
  %sub = fsub double %fneg, %call
  %div = fdiv double %sub, %a
  ret double %div
}

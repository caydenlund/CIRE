; ModuleID = '/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/NMSEp42_negative.c'
source_filename = "/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/NMSEp42_negative.c"
...
entry:
  %fneg = fneg double %b
  %mul1 = fmul double %a, %c
  %neg = fmul double %mul1, -4.000000e+00
  %0 = tail call double @llvm.fmuladd.f64(double %b, double %b, double %neg)

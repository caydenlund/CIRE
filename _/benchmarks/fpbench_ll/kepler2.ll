; ModuleID = '/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/kepler2.c'
source_filename = "/home/tanmay/Documents/Tools/CIRE/benchmarks/fpbench_c/kepler2.c"
...
entry:
  ...
  %4 = fneg double %x1
  %neg23 = fmul double %4, %x3
  %5 = tail call double @llvm.fmuladd.f64(double %neg23, double %x5, double %3)
  %neg26 = fmul double %4, %x2
  %6 = tail call double @llvm.fmuladd.f64(double %neg26, double %x6, double %5)
  %7 = fneg double %x4
  %neg29 = fmul double %7, %x5
  %8 = tail call double @llvm.fmuladd.f64(double %neg29, double %x6, double %6)
  ret double %8
}

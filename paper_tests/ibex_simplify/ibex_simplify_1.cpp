...
//            ((((w0 * (0.0 - m0)) * (-3.0 * ((1.0 * (a0/w0)) * (a0/w0)))) * 1.0) + 0.0)))).simplify(3));
//  Function r(
//          {m0, m1, m2, w0, w1, w2, a0, a1, a2},
//          (-(((3*((m0*w0)*pow(a0/w0, 2)))+(3*((m1*w1)*pow(a1/w1, 2))))+(3*((m2*w2)*pow(a2/w2, 2))))));
  Function r(
          {m0, m1, m2, w0, w1, w2, a0, a1, a2},
          (-(((3*((m0/w0)*pow(a0, 2)))+(3*((m1/w1)*pow(a1, 2))))+(3*((m2/w2)*pow(a2, 2))))));
